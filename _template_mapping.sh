...
python parse_barcode2.py '{library}' $path_fastq_files$base_fastq $inFileLength
...
macs2 callpeak -t $path_out$base_fastq'.sorted.bam' -f BAMPE --min-length 10000 --max-gap 5000 -q 0.01 --broad --outdir '{experiment}/macs2'
